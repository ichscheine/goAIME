#!/usr/bin/env python3
# filepath: /Users/daoming/Documents/Github/goAIME/create_test_user_simple.py
"""
...
def main():
    ...
    # Try to load MongoDB connection from environment
    mongodb_uri = os.environ.get('MONGODB_URI')
    if not mongodb_uri:
        # Default to local MongoDB if not found in environment
