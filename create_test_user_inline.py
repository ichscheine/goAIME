#!/usr/bin/env python3
# filepath: /Users/daoming/Documents/Github/goAIME/create_test_user_inline.py
"""
Script to create a test user with enhanced performance data by duplicating goAmy's sessions.
This script uses inline MongoDB connection to avoid dependency on backend modules.
"""
...
def create_enhanced_user_sessions():
    ...
    # Connect to MongoDB directly using localhost
    # This is a fallback if we can't use the project's connection method
    try:
...
if __name__ == "__main__":
    success = create_enhanced_user_sessions()
